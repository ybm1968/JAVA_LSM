...
public class Upcasting {
	...
	public static void main(String[] args) {
		// 업캐스팅 (자동타입변환) 부모클래스 = 자식클래스
		Person person = new Student("김조은", 20, 1, "신재생");
...
//		System.out.println("major : " + person.major);
		...
		// 클래스를 업캐스팅하면 변수는 부모 클래스에 있는 변수만 접근 가능하고
		// 메소드는 자식 클래스에 메소드가 우선하여 실행된다.
		
		System.out.println(person);
		System.out.println(person.work());
		
		
		// 바인딩 : 프로그램에서 사용되는 요소에 실제 값을 결정짓는 행위
		// - 정적 바인딩 
		// : 컴파일 시간에 결정
		// 변수 등
		// - 동적 바인딩 :
