...
public class SimpleDateFormatEx {
	...
	public static void main(String[] args) throws ParseException {
		...
		*/
		...
		sdf = new SimpleDateFormat("올해 첫 날부터 D번쨰 날");
		System.out.println(sdf.format(date));
		
		sdf = new SimpleDateFormat("이번 달 첫 날부터 d번쨰 날");
		System.out.println(sdf.format(date));
		
		sdf = new SimpleDateFormat("올해의 w 주차 입니다.");
		System.out.println(sdf.format(date));
		
		sdf = new SimpleDateFormat("이번 달의 W 주차 입니다.");
		System.out.println(sdf.format(date));
